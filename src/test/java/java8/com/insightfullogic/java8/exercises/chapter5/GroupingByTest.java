...
import java8.com.insightfullogic.java8.answers.chapter5.GroupingBy;
...
public class GroupingByTest {
    ...
    public void stringsByLength() {
        GroupingBy<String, Integer> stringIntegerGroupingBy = new GroupingBy<String, Integer>(s -> s.length());
